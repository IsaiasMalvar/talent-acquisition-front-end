...
import { TalentRequestFulfillment } from "../types";
...
const getTalentFulfillmentById = async (talentFulfillmentId: string) => {
...
const approveTalentFulfillmentJobPost = async (
    approvedTalentFulfillment: TalentRequestFulfillment
) => {
